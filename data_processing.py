...
def load_data(train_start, train_end, test_start, test_end, building, meter_keys,
    ...
    train_ddpg_mains_df, train_ddpg_appliance_df, _, _ = ddpg_call_preprocessing(train_main_values, train_meters_values[0],train_main_mean, train_main_std, train_meter_means[0], train_meter_stds[0],window_size,
    ...
    test_ddpg_mains_df, test_ddpg_appliance_df, _, _ = ddpg_call_preprocessing(test_main_values, test_meters_values[0],
                                                                     ...
                                                                     train_meter_means[0], train_meter_stds[0],
                                                                     window_size,
                                                                     batch_size, train=True)
    ...
    if method=='closed':
        ...
        return train_ddpg_mains_df, train_ddpg_appliance_df,test_ddpg_mains_df,  test_ddpg_appliance_df,train_meter_means[0], train_meter_stds[0]
